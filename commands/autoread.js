    ...
    try {
        ...
        await sock.sendMessage(chatId, {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '.',
                    newsletterName: '흫_ᬉ᭰ᮁᤳ𝙈𝙍ܓ WASSI </06_ᬉ᭰',
                    serverMessageId: -1
                }
            }
        });
...
function isBotMentionedInMessage(message, botNumber) {
    ...
    if (textContent) {
        ...
        const botNames = [global.botname?.toLowerCase(), 'bot', '흫_ᬉ᭰ᮁᤳ𝙈𝙍ܓ WASSI </06_ᬉ᭰', '흫_ᬉ᭰ᮁᤳ𝙈𝙍ܓ WASSI </06_ᬉ᭰'];
